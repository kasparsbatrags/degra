...
public class CustomerDataFactory {
	...
	public static Customer createCustomer(int id, String name, CustomerType customerType, String regNumber, String vatNumber,
			Address address) {
	...
	public static Address createAddress(Integer id, Integer code, Integer type, String status, Integer parentCode, Integer parentType,
			String name, String sortByValue, String zip, LocalDate dateFrom, LocalDate updateDatePublic, LocalDate dateTo, String fullName,
			Integer territorialUnitCode) {
