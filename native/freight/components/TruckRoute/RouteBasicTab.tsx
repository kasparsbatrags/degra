...
const RouteBasicTab: React.FC<RouteBasicTabProps> = ({
	...
	if (isItRouteFinish) {
		...
		return (<View style={[styles.tabContentContainer, styles.basicTabContent]}>
					...
					<ImprovedFormDropdownWithAddButtonOffline
							...
							onAddPress={() => router.push({
								pathname: '/add-truck-object', params: {type: 'inTruckObject'}
							})}
					/>
				</View>)
	}
	...
	return (<View style={[styles.tabContentContainer, styles.basicTabContent]}>
				...
				<ImprovedFormDropdownWithAddButtonOffline
						...
						onAddPress={() => router.push({
							pathname: '/add-truck-object', params: {type: 'outTruckObject'}
						})}
						forceRefresh={refreshDropdowns}
