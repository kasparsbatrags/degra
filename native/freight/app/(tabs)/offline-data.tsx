...
const styles = StyleSheet.create({
	webContainer: Platform.OS === 'web' ? {
		...
		fontSize: 16, marginBottom: 16, color: COLORS.gray,
	}, emptyContainer: {
		flex: 1, justifyContent: 'center', alignItems: 'center', marginTop: 32,
	}, emptyText: {
		...
		fontSize: 12, color: COLORS.gray, marginTop: 4,
		...
		backgroundColor: COLORS.black100, borderWidth: 1, borderColor: 'rgba(255, 255, 255, 0.05)', ...SHADOWS.small,
	} : {
		backgroundColor: COLORS.black100, borderWidth: 1, borderColor: 'rgba(255, 255, 255, 0.15)', ...SHADOWS.medium,
	},
})
