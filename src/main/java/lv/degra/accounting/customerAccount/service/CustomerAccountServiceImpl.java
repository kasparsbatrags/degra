...
public class CustomerAccountServiceImpl implements CustomerAccountService {
    ...
    public ObservableList<CustomerBankAccount> getCustomerAccounts(Customer customer) {
        return FXCollections.observableList(customerAccountRepository.findByCustomer(customer.getId()));
    }
    public ObservableList<CustomerBankAccount> getCustomerBankAccounts(Customer customer, Bank bank) {
